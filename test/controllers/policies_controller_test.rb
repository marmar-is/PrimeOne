...
class PoliciesControllerTest < ActionController::TestCase
  ...
  test "should create policy" do
    assert_difference('Policy.count') do
      post :create, policy: { code: @policy.code, effective: @policy.effective, name: @policy.name, number: @policy.number, status: @policy.status }
    end
  ...
  test "should update policy" do
    patch :update, id: @policy, policy: { code: @policy.code, effective: @policy.effective, name: @policy.name, number: @policy.number, status: @policy.status }
    assert_redirected_to policy_path(assigns(:policy))
  end
